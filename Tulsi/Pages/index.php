        ...
        <div class="col-md-6">
          <div class="form_container">
            <form action="">
              ...
              <div>
                <input type="number" class="form-control" placeholder="How many persons?"/>
              </div>
              <div>
                <input type="number" class="form-control" placeholder="How many tables?"/>
              </div>
              <div>
              ...
              <div class="btn-box">
                    <button type="submit" class="btn btn-primary btn-lock">
                      <a href="../Pages/booknow.php" style=" color:#fff; font-weight:600;">Book Now</a>
                    </button>
              </div>
            </form>
          </div>
        ...
        <div class="owl-carousel client_owl-carousel">
          ...
          <div class="item">
            <div class="box">
              <div class="detail-box">
                <p>
                  The food was excellent and so was the service.  I had the mushroom risotto with scallops which was awesome. My friend had a burger over greens (gluten-free) which was also very good.
                </p>
                <h6>
                  Dustin Henderson
                </h6>
